if (isDebugMode()) {
  ...
  function addDebugScript() {
    ...
    debugScript.setAttribute('src', 'https://jeff-pe.surge.sh/webflow-sin-room-v5.js');
    $('.sin-room-body').append(debugScript);
    const debugStyle = document.createElement('link');
    debugStyle.setAttribute('rel', 'stylesheet');
    debugStyle.setAttribute('href', 'https://jeff-pe.surge.sh/webflow-sin-room-v5.css');
  ...
  function main() {
    ...
    let prodFlag = true;
    $('#player').attr('src', 'https://passion-experience.s3.amazonaws.com/assets/2021/pe-page5/en/PE21_page5-SinInOurHearts.mp3');
    ...
    */
    ...
    // const finalCardBeginRevealD = 1800;
    // const finalCardEndRevealD = 1200;
    // const finalCardRevealSpace = finalCardBeginRevealD - finalCardEndRevealD;
